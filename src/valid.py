...
if __name__ == '__main__':
    ...
    # data loading
    _, valid_loader = dataparse.build_loader(args, validonly=True, ratio=0.25)
    
    # models
    model, optimizer, scheduler, forward = modeling.build_model(args, device, checkpoint=args.checkpoint)
